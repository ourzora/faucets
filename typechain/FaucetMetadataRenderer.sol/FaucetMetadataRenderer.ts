...
export interface FaucetMetadataRendererInterface extends utils.Interface {
  functions: {
    "getTokenURIForFaucet(address,uint256,(uint256,uint256,uint256,uint256,address,address,bool))": FunctionFragment;
    "renderSVG(address,uint256,(uint256,uint256,uint256,uint256,address,address,bool))": FunctionFragment;
  };

  getFunction(
    nameOrSignatureOrTopic: "getTokenURIForFaucet" | "renderSVG"
  ): FunctionFragment;
...
export interface FaucetMetadataRenderer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FaucetMetadataRendererInterface;
