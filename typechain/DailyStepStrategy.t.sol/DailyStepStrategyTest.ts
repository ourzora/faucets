...
export interface DailyStepStrategyTestInterface extends utils.Interface {
  functions: {
...
export interface DailyStepStrategyTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DailyStepStrategyTestInterface;
