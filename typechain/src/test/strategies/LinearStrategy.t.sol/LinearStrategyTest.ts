...
export interface LinearStrategyTestInterface extends utils.Interface {
  functions: {
    "IS_SCRIPT()": FunctionFragment;
    "IS_TEST()": FunctionFragment;
    "failed()": FunctionFragment;
    "setUp()": FunctionFragment;
    "test_beyondEnd(uint256,uint256,uint256)": FunctionFragment;
    "test_end(uint256,uint256,uint256)": FunctionFragment;
    "test_middle(uint256,uint256,uint256)": FunctionFragment;
    "test_t0(uint256,uint256,uint256)": FunctionFragment;
    "vm()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "test_beyondEnd",
    values: [BigNumberish, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "test_end",
    values: [BigNumberish, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "test_middle",
    values: [BigNumberish, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "test_t0",
    values: [BigNumberish, BigNumberish, BigNumberish]
  ): string;
  ...
  decodeFunctionResult(functionFragment: "test_end", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "test_middle",
    data: BytesLike
  ): Result;
  decodeFunctionResult(functionFragment: "test_t0", data: BytesLike): Result;
...
export interface LinearStrategyTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LinearStrategyTestInterface;
