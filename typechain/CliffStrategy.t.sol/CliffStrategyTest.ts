...
export interface CliffStrategyTestInterface extends utils.Interface {
  functions: {
...
export interface CliffStrategyTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CliffStrategyTestInterface;
