...
export interface DeployStrategiesInterface extends utils.Interface {
  functions: {
...
export interface DeployStrategies extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployStrategiesInterface;
