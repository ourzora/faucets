...
export interface ERC20FaucetTestInterface extends utils.Interface {
  functions: {
    "IS_SCRIPT()": FunctionFragment;
    "IS_TEST()": FunctionFragment;
    "failed()": FunctionFragment;
    "setUp()": FunctionFragment;
    "test_claim_expiry(uint256,uint96)": FunctionFragment;
    "test_claim_ongoing(uint256,uint96,uint96)": FunctionFragment;
    "test_claim_past_expiry(uint256,uint96)": FunctionFragment;
    "test_claim_t0(uint256,uint96)": FunctionFragment;
    "test_mint(uint256,uint96)": FunctionFragment;
    "test_rescind_ongoing(uint256,uint96,uint96)": FunctionFragment;
    "test_rescind_t0(uint256,uint96)": FunctionFragment;
    "test_revertClaim_onlyOwner(uint256,uint96)": FunctionFragment;
    "test_revertMint_invalidFaucet()": FunctionFragment;
    "test_revertMint_zeroAmount(uint256)": FunctionFragment;
    "test_revertMint_zeroDuration(uint256)": FunctionFragment;
    "test_revertRescind_onlyRescindable(uint256,uint96)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "test_claim_t0"
      | "test_mint"
      | "test_rescind_ongoing"
      | "test_rescind_t0"
      | "test_revertClaim_onlyOwner"
      | "test_revertMint_invalidFaucet"
      | "test_revertMint_zeroAmount"
      | "test_revertMint_zeroDuration"
  ...
  encodeFunctionData(
    functionFragment: "test_claim_ongoing",
  ...
  encodeFunctionData(
    functionFragment: "test_mint",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "test_rescind_ongoing",
    values: [BigNumberish, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "test_revertMint_zeroAmount",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "test_revertMint_zeroDuration",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface ERC20FaucetTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC20FaucetTestInterface;
