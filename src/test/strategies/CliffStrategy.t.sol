...
contract CliffStrategyTest is Test {
    CliffStrategy internal strat;

    function setUp() public {
        strat = new CliffStrategy();
    }
    ...
    function test_middle(
        ...
        assertEq(strat.claimableAtTimestamp(numTokens, start, expiry, (start + expiry) / 2), 0);
    }
}
